...
const INVITATION_COLLECTION_SCHEMA = Joi.object({
  ...
  // Lời mời là board nên sẽ lưu thêm dữ liệu boardInvitation - optional - vì nếu sau này mở rỗng những lời mời khác ví dụ lời mời vào Workspace thì có thể sẽ có workspaceInvitation chứ ko phải boardInvitation như này

...
const updateBoardInvitation = async (userId, invitationId, status) => {
  try {
    ...
    // console.log('chưa toString: ', [...getBoard.ownerIds, ...getBoard.memberIds])
    const boardOwnerAndMemberIds = [...getBoard.ownerIds, ...getBoard.memberIds].toString()
    // console.log('đã toString', boardOwnerAndMemberIds)
    // console.log('kiểu đã toString', typeof(boardOwnerAndMemberIds))
